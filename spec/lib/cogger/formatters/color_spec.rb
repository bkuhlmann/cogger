...
RSpec.describe Cogger::Formatters::Color do
  ...
  describe "#call" do
    ...
    let(:entry) { Cogger::Entry.for at:, message: "Test." }
    ...
    context "with dynamic element" do
      ...
      it "answers colorized string" do
        result = formatter.call entry
        expect(result).to have_color(color, ["INFO #{at_format} rspec Test.", :green], ["\n"])
      end
    end
    ...
    context "with specific element" do
      ...
      it "answers colorized string" do
        result = formatter.call entry
        expect(result).to have_color(color, ["INFO #{at_format} rspec Test.", :cyan], ["\n"])
      end
    end
    ...
    context "with dynamic and specific keys" do
      ...
      it "answers colorized string" do
        result = formatter.call Cogger::Entry.for level: "FATAL", at:, message: "Test."
        expect(result).to have_color(color, *proof)
      end
    end
    ...
    context "with dynamic emoji" do
      ...
      it "answers colorized string" do
        result = formatter.call Cogger::Entry.for level: "ANY", at:, message: "Test."
    ...
    context "with specific emoji" do
      ...
      it "answers string without leading space" do
        result = formatter.call Cogger::Entry.for level: "INFO", at:, message: "Test."
