...
* 🔼 Updated to Tone 2.0.0 - Brooke Kuhlmann
...
* ✅ Fixed logger deprecation warning - Brooke Kuhlmann
* 🟢 Added log device refinement - Brooke Kuhlmann
* 🟢 Added logger refinement - Brooke Kuhlmann
* 🔁 Refactored hub to use new logger refinements - Brooke Kuhlmann
